 ...
 implements talk.chatOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("diffuserMessage", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // talk/chat/diffuserMessage
       {
         String message = in.read_string ();
         this.diffuserMessage (message);
         out = $rh.createReply();
         break;
       }

       case 1:  // talk/chat/enregistrer
       {
         String idObj = in.read_string ();
         this.enregistrer (idObj);
         out = $rh.createReply();
         break;
       }
